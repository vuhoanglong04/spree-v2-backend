class Api::Admin::RolePermissionsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @role_permission.update(role_permission_params)
        format.html { redirect_to @role_permission, notice: "Role permission was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to role_permissions_path, notice: "Role permission was successfully destroyed.", status: :see_other }
