class Api::V1::PromotionsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @promotion.update(promotion_params)
        format.html { redirect_to @promotion, notice: "Promotion was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to promotions_path, notice: "Promotion was successfully destroyed.", status: :see_other }
